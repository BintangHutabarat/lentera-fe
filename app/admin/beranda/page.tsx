...
import { Bell, Lightbulb, GraduationCap, Users, BookOpen, LogOut, BookMarked, CalendarDays, CalendarRange, Crown } from "lucide-react";
...
const QUICK_ACTIONS = [
  { label: "Data Guru",     Icon: GraduationCap, href: "/admin/guru",                  color: "#22A96C", bg: "#E0F7EC" },
  ...
  { label: "Tahun Ajaran",  Icon: CalendarRange,  href: "/admin/tahun-ajaran",          color: "#22A96C", bg: "#E0F7EC" },
  { label: "Kepala Sekolah",Icon: Crown,          href: "/admin/kepala-sekolah/buat",   color: "#7a5cf1", bg: "#EDF3FF" },
];
