...
import { Lock, HelpCircle, LogOut, Loader2, Bell, Settings } from "lucide-react";
...
export default function AdminProfilPage() {
  ...
  const MENU_ITEMS: MenuItem[] = [
    ...
    { Icon: Settings,   bg: "#EDF3FF", label: "Pengaturan Sistem", danger: false },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-[12px] text-white/80 mt-1">{profile?.school ?? ""}</div>
      </div>
      ...
      <div className="px-3.5">
        <div className="card -mt-7 relative z-10 mb-3.5">
          <div className="grid grid-cols-2 text-center divide-x divide-border">
            {[
              { val: profile?.scope ?? "SCHOOL", color: "#4361EE", label: "Scope" },
