...
export default function TugasPage() {
  ...
  return (
    <>
      <PageTopbar title="Tugas" subtitle={`${mockAssignments.length} tugas aktif`} />
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-1.5 flex-wrap mb-2">
                  <Chip variant={a.subjectColor === "purple" ? "purple" : a.subjectColor as never}>
                    {a.subject}
                  </Chip>
                  <span
                ...
                <div className="flex gap-2.5 pt-2 border-t border-surface-soft items-center">
                  <span className="text-[10px] text-ink-muted flex items-center gap-1">
                    <GraduationCap size={11} /> {a.teacher}
                  </span>
                  <span className="text-[10px] text-ink-muted flex items-center gap-1">
